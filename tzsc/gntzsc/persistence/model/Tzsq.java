 ...
 * </pre>
 */
public class Tzsq extends AbstractModel<String>{
	...
	*/
	 ...
	 * 船舶种类 字段转换
	 */
	private  String  cbzlName = "";

	public String getCbzlName() {
		if(StaticMethod.isNotEmpty(cbzlName)) {
			return cbzlName;
		}
		SysDict sysDict = sysDictManager.getSysDictByDictCodeAndDictId("CBLX", this.cbzl);
		if(StaticMethod.isNotEmpty(sysDict)) {
			cbzlName = sysDict.getDictName();
		}
		return cbzlName;
	}
